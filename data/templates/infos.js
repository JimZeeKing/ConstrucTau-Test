...
<div class="head">{{it.fullName}}</div>
  <div class="row">
    ...
    <div class="cell invisible-text" id='vocableFR' data-remove-class='invisible-text'>{{it.vocableFR}}</div>
  </div>
  <div class="row">
    ...
    <div class="cell invisible-text" id='vocableEN' data-remove-class='invisible-text'>{{it.vocableEN}}</div>
  </div>
  <div class="row">
    ...
    <div class="cell invisible-text" id='mat-name' data-remove-class='invisible-text'>{{it.materials.name}}</div>
    <div class="cell invisible-text" id='mat-desc' data-remove-class='invisible-text'>{{it.materials.description}}</div>
  </div>
   <div class="row">
    ...
    <div class="cell invisible-text" id='sizes' data-remove-class='invisible-text'>Hauteur {{it.standradSizes.height}}
  ...
  <div class="row">
    ...
    <div class="cell invisible-text" id='sizes-h' data-remove-class='invisible-text'>Hauteur : <br>{{it.possibleSizes.height}}</div>
    <div class="cell invisible-text" id='sizes-w' data-remove-class='invisible-text'>Largeur : <br>{{it.possibleSizes.width}}</div>
  </div>
  ...
  <div class="row">
    ...
    <div class="cell invisible-text" id='description' data-remove-class='invisible-text'>{{it.description}}</div>
  </div>
