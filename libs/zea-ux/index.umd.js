...
`
   ...
   * @extends TreeItem
   */
  class DomTree extends zeaEngine.TreeItem {
    /**
    ...
    constructor(name, domElement) {
      ...
      this.pixelsPerMeter = new zeaEngine.NumberParameter('PixelsPerMeter', 2000.0);
      ...
      const unitsConversion = new zeaEngine.TreeItem('Units');
      ...
      this.size = new zeaEngine.Vec3(domElement.clientWidth * sc, domElement.clientHeight * sc, 1);
      this.ready = false;
      ...
      const resizeObserver = new ResizeObserver((entries) => {
        ...
        traverse(domElement, 0, (elem, depth) => {
          if (elem.classList.contains('widget')) {
            ...
            localXfo.ori.setFromAxisAndAngle(new zeaEngine.Vec3(0, 0, 1), Math.PI);
  ...
  class VRUITool extends zeaEngine.BaseTool {
    ...
    displayUI(uiController, pointerController, headXfo) {
      ...
      uiLocalXfo.ori.setFromEulerAngles(new zeaEngine.EulerAngles(Math.PI, Math.PI, 0));
